    ...
    <div className="container pt-0 pb-8 max-w-7xl">
      <div className="mb-4">
        <div className="flex items-center justify-between">
          <h1 className="text-2xl font-bold">Offers and Promotions</h1>
          <Button onClick={() => router.push("/dashboard")} variant="ghost" className="text-gray-500">
            <ArrowLeft className="mr-2 h-4 w-4" />
            Back to Dashboard
          </Button>
        </div>
        <p className="text-gray-500">Discover offers and promotions available for you</p>
      </div>
      ...
      {filteredOffers.length === 0 ? (
        <div className="text-center py-12">
          ...
          <p className="text-gray-500">We couldn't find any offers matching your search criteria.</p>
        </div>
      ) : (
